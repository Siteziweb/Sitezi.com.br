...
(() => {
  ...
  function planCost(){const p=currentPlan();if(p.includes("master"))return 10;if(p.includes("premium"))return 12;if(p.includes("profissional"))return 15;if(p.includes("básico")||p.includes("basico"))return 20;return null}
